...
A community network is a free public social network with local control.

1. [what is community networking?](introduction/)
1. [buy kit parts](buy/)
2. [install system](install/)
2. [run linux](linux/)
3. [build servers](servers/)
4. [learn markdown](markdown/)
5. [learn html](learnhtml/)
6. [learn CSS](learncss/)
7. [learn JavaScript](learnjavascript/)
8. [learn PHP](learnphp/)
9. [learn python](python/)
10. [learn Arduino](arduino/)
11. [build off grid power](power/)
12. [build wireless networks](wireless/)
13. [operate a station](operations/)
14. [teach new operators](teaching/)
...
## Links
 ...
 - [hyperreplicator.php](hyperreplicator.php)
